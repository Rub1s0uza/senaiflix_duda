...
if($_SERVER ['REQUEST_METHOD'] == "POST"){
    ...
    if(move_uploaded_file($foto["tmp_name"], $caminho_completo)){
        echo "O arquivofoi enviado com sucesso";
    } else {
        echo "Erro ao enviar o arquivo";
    }

    $sql = "INSERT INTO filmes (titulo, descricao, ano_lancamento, genero, classificacao, foto, data_cadastro, data_atualizacao, status) VALUES 
    ('$titulo', '$descricao', '$ano_lancamento', '$genero', '$classificacao', '$nome_arquivo',$data_cadastro', '$data_atualizacao', '$status')";
