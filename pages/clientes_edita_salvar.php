...
if($_SERVER ['REQUEST_METHOD'] == "POST"){
    ...
    $q = "UPDATE clientes SET nome='$nome', email='$email', cpf='$cpf', telefone='$telefone', endereco='$endereco', bairro='$bairro', estado='$estado', cep='$cep',        data_cadastro='$data_cadastro', data_atualizacao='$data_atualizacao' WHERE id='$id'";
