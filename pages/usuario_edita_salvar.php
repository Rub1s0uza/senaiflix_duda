...
if($_SERVER ['REQUEST_METHOD'] == "POST"){
    ...
    $q = "UPDATE usuarios SET nome='$nome', usuario='$usuario', senha='$senha', email='$email', data_cadastro='$data_cadastro', data_atualizacao='$data_atualizacao' WHERE id_usuario='$id_usuario'";
